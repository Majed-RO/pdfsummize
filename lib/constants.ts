...
export const plans = [
	{
		...
		id: 'basic',
		paymentLink: isDev
			? 'https://buy.stripe.com/test_aFa8wO13z9N90Qt1Rn4Ni00'
			: '',
		priceId: isDev ? 'price_1S4l8XD5Z0jAZbYsuuMNbhaB' : ''
	},
	{
		name: 'Pro',
		price: 24,
		...
		id: 'pro',
		paymentLink: isDev
			? 'https://buy.stripe.com/test_9B6aEW7rX1gDdDfeE94Ni01'
			: '',

		priceId: isDev ? 'price_1S4l8XD5Z0jAZbYs6hFAKxp9' : ''
	}
];
